...
%%
% LECTURA DEL HEXAPOD OUTPUT FILE Y ASIGNACIÓN DE VARIABLES
...
control(4) = 3.5;% Distancia del paso [cm]
...
pivot = [0 ; 0 ; control(3)];   % Posición inicial del robot
